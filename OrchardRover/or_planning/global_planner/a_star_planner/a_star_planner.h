#ifndef OR_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
#define OR_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
...
namespace or_global_planner
{
    ...
    public:
         ...
         */
        or_common::ErrorInfo Plan(const geometry_msgs::PoseStamped &start,
    ...
    private:
         ...
         * @return ErrorInfo which is OK if succeed
         */
        or_common::ErrorInfo SearchPath(const int &start_index,
         ...
         * @return ErrorInfo which is OK if succeed
         */
        or_common::ErrorInfo GetMoveCost(const int &current_index,
...
#endif // OR_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
