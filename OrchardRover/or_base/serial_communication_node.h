...
namespace leonard_serial_communication {
    ...
    private:
        ...
        Eigen::Isometry3d ComputeLocalFrameFromLatLong(const double latitude, const double longitude);
    ...
    private:
        ...
        Eigen::Isometry3d ecef_to_local_frame_;
        Eigen::Vector3d gps_origin_frame_;
