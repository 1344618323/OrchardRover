...
class TrunkDetector:
    def __init__(self):
        ...
        # self.sub_ = message_filters.Subscriber('/usb_cam/image_raw', Image)
        # self.sub_.registerCallback(self.myCallback)
...
if __name__ == '__main__':
    rospy.init_node('trunk_detection_laser_cam', anonymous=True)
    ...
    while not rospy.is_shutdown():
        ...
        # cam_laser.ShowProject(process_img);
        # cv2.imshow("show", process_img)
        # cv2.waitKey(5)
