...
class ParaObstacleLayer : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:or_costmap.ParaObstacleLayer) */ {
 public:
  ParaObstacleLayer();
  ...
  inline ParaObstacleLayer* New() const PROTOBUF_FINAL { return New(NULL); }

  ParaObstacleLayer* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:or_costmap.ParaObstacleLayer)
 private:
