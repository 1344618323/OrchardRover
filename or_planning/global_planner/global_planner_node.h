...
#ifndef OR_PLANNING_GLOBAL_PLANNER_NODE_H
#define OR_PLANNING_GLOBAL_PLANNER_NODE_H
 ...
 */
    ...
    public:
        ...
        typedef actionlib::SimpleActionServer <or_msgs::GlobalPlannerAction> GlobalPlannerServer;
    ...
    private:
         ...
         */
        void GoalCallback(const or_msgs::GlobalPlannerGoal::ConstPtr &msg);

        /**
         * @brief Set the state for planning module
         * @param node_state Enumerate State for global planning
         */
        void SetNodeState(or_common::NodeState node_state);
         ...
         */
        void SetErrorInfo(or_common::ErrorInfo error_info);
        ...
        or_common::ErrorInfo error_info_;
...
#endif //OR_PLANNING_GLOBAL_PLANNER_NODE_H
