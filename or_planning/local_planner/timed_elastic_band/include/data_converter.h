...
#ifndef OR_PLANNING_DATA_CONVERTER_H
#define OR_PLANNING_DATA_CONVERTER_H
...
namespace or_local_planner {
    ...
    public:
        /**
         * @brief Convert or_costmap::RobotPose to std::pair<Eigen::Vector2d, double>
         * @param pose Data structure of or_costmap::RobotPose
         * @return Data structure of std::pair<Eigen::Vector2d, double>
         */
        static std::pair<Eigen::Vector2d, double> LocalConvertRMData(const or_costmap::RobotPose &pose) {
...
#endif //OR_PLANNING_DATA_CONVERTER_H
